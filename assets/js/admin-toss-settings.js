jQuery(document).ready(function($) {
    ...
    const $testModeCheckbox = $('#mphb-mphb_toss_global_test_mode');
    const $clientKeyInput   = $('#mphb-mphb_toss_global_client_key');
    const $secretKeyInput   = $('#mphb-mphb_toss_global_secret_key');

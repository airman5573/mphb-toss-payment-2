...
class TossGatewayNpay extends TossGatewayBase {
     ...
     * 네이버페이와 같은 간편결제는 'CARD'로 처리되고, JS에서 easyPay provider 코드가 사용됩니다.
    ...
    /**
     * 간편결제 제공사 코드를 반환합니다.
     * @return string 간편결제 제공사 코드 (네이버페이)
     */
     ...
     * 부모 클래스의 처리를 호출한 후, 네이버페이 관련 정보를 결제 메타데이터로 저장합니다.

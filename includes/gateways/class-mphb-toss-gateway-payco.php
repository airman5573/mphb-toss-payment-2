...
class TossGatewayPayco extends TossGatewayBase {
     ...
     * 페이코와 같은 간편결제는 'CARD'로 처리되고, JS에서 easyPay provider 코드가 사용됩니다.
     ...
     * 부모 클래스의 처리를 호출한 후, 페이코 관련 정보를 결제 메타데이터로 저장합니다.
